...
TINY_XML_CPPS = tinyxml/tinyxml.cpp tinyxml/tinystr.cpp tinyxml/tinyxmlparser.cpp tinyxml/tinyxmlerror.cpp src/World.cpp src/Layer.cpp src/Tileset.cpp src/Camera.cpp src/PhysicsEngine.cpp src/MapGameState.cpp
